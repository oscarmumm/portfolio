...
export const Header = () => {
    ...
    return (
        <header className="fixed top-0 w-full h-16 flex items-center justify-between p-3 shadow-xl z-40 bg-white text-slate-900 dark:bg-slate-900 dark:text-slate-50">
            <h1>OSCAR</h1>
            <button
